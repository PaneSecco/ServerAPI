...
//
//il bind param è fatto solo per la tabella computer
//
...
if ($metodo=="POST"){
   ...
   //converte in array associativo
    ...
    if(array_key_exists('nome_tabella', $data) &&
    ...
    count($data) >= 3){
        ...
        //se è stato messo id inutilmente lo tolgo
        unset($array_dati['id']);
        ...
        if($data['nome_tabella']=="computer"){
            ...
            $stmt->bind_param('ssisss', 
                $array_dati['marca'], 
                $array_dati['modello'], 
                $array_dati['numero_di_serie'], 
                $array_dati['tipo'], 
                $array_dati['anno_acquisto'], 
                $array_dati['specifiche_tecniche']
            );
...
if ($metodo=="DELETE"){
    ...
    count($data) >= 3){
        ...
        $sql="";
        if($data['nome_tabella']=="computer"){
            $sql = "DELETE FROM ".$data["nome_tabella"]. " WHERE id = ?;";
        }else{
